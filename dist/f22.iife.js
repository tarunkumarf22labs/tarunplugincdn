 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ru=Zc;function mr(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const i=Object.assign({name:vi,automaticDataCollectionEnabled:!1},t),s=i.name;if(typeof s!="string"||!s)throw Tt.create("bad-app-name",{appName:String(s)});if(n||(n=tc()),!n)throw Tt.create("no-options");const r=an.get(s);if(r){if(ui(n,r.options)&&ui(i,r.config))return r;throw Tt.create("duplicate-app",{appName:s})}const o=new hc(s);for(const l of wi.values())o.addComponent(l);const a=new su(n,i,o);return an.set(s,a),a}function ou(e=vi){const t=an.get(e);if(!t&&e===vi)return mr();if(!t)throw Tt.create("no-app",{appName:e});return t}function Kt(e,t,n){var i;let s=(i=tu[e])!==null&&i!==void 0?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${t}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Ot.warn(a.join(" "));return}ln(new de(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D(e="Unexpected state"){const t=`FIRESTORE (${Yt}) INTERNAL ASSERTION FAILED: `+e;throw Ut(t),new Error(t)}function B(e,t){e||D()}function O(e,t){return e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $o{constructor(t,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class vh{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,n){t.enqueueRetryable(()=>n(tt.UNAUTHENTICATED))}shutdown(){}}class wh{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,n){this.changeListener=n,t.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class _h{constructor(t){this.t=t,this.currentUser=tt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,n){let i=this.i;const s=l=>this.i!==i?(i=this.i,n(l)):Promise.resolve();let r=new $t;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new $t,t.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const l=r;t.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},a=l=>{w("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(w("FirebaseAuthCredentialsProvider","Auth not yet detected"),r.resolve(),r=new $t)}},0),o()}getToken(){const t=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(i=>this.i!==t?(w("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):i?(B(typeof i.accessToken=="string"),new $o(i.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const t=this.auth&&this.auth.getUid();return B(t===null||typeof t=="string"),new tt(t)}}class Eh{constructor(t,n,i,s){this.h=t,this.l=n,this.m=i,this.g=s,this.type="FirstParty",this.user=tt.FIRST_PARTY,this.p=new Map}I(){return this.g?this.g():(B(!(typeof this.h!="object"||this.h===null||!this.h.auth||!this.h.auth.getAuthHeaderValueForFirstParty)),this.h.auth.getAuthHeaderValueForFirstParty([]))}get headers(){this.p.set("X-Goog-AuthUser",this.l);const t=this.I();return t&&this.p.set("Authorization",t),this.m&&this.p.set("X-Goog-Iam-Authorization-Token",this.m),this.p}}class Ch{constructor(t,n,i,s){this.h=t,this.l=n,this.m=i,this.g=s}getToken(){return Promise.resolve(new Eh(this.h,this.l,this.m,this.g))}start(t,n){t.enqueueRetryable(()=>n(tt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class bh{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Th{constructor(t){this.T=t,this.forceRefresh=!1,this.appCheck=null,this.A=null}start(t,n){const i=r=>{r.error!=null&&w("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${r.error.message}`);const o=r.token!==this.A;return this.A=r.token,w("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(r.token):Promise.resolve()};this.o=r=>{t.enqueueRetryable(()=>i(r))};const s=r=>{w("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=r,this.appCheck.addTokenListener(this.o)};this.T.onInit(r=>s(r)),setTimeout(()=>{if(!this.appCheck){const r=this.T.getImmediate({optional:!0});r?s(r):w("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(n=>n?(B(typeof n.token=="string"),this.A=n.token,new bh(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mh(e){var t,n;return((n=(((t=e==null?void 0:e.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Un(e){const t=Bt(e.mapValue.fields.__local_write_time__.timestampValue);return new H(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{}class q extends Qo{constructor(t,n,i){super(),this.field=t,this.op=n,this.value=i}static create(t,n,i){return t.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(t,n,i):new Vh(t,n,i):n==="array-contains"?new Bh(t,i):n==="in"?new Hh(t,i):n==="not-in"?new jh(t,i):n==="array-contains-any"?new qh(t,i):new q(t,n,i)}static createKeyFieldInFilter(t,n,i){return n==="in"?new Uh(t,i):new $h(t,i)}matches(t){const n=t.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(te(n,this.value)):n!==null&&Zt(this.value)===Zt(n)&&this.matchesComparison(te(n,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return D()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}}class Dt extends Qo{constructor(t,n){super(),this.filters=t,this.op=n,this.ht=null}static create(t,n){return new Dt(t,n)}matches(t){return Xo(this)?this.filters.find(n=>!n.matches(t))===void 0:this.filters.find(n=>n.matches(t))!==void 0}getFlattenedFilters(){return this.ht!==null||(this.ht=this.filters.reduce((t,n)=>t.concat(n.getFlattenedFilters()),[])),this.ht}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const t=this.lt(n=>n.isInequality());return t!==null?t.field:null}lt(t){for(const n of this.getFlattenedFilters())if(t(n))return n;return null}}function Xo(e){return e.op==="and"}function Yo(e){return Fh(e)&&Xo(e)}function Fh(e){for(const t of e.filters)if(t instanceof Dt)return!1;return!0}function ds(e){if(e instanceof q)return e.field.canonicalString()+e.op.toString()+ee(e.value);if(Yo(e))return e.filters.map(t=>ds(t)).join(",");{const t=e.filters.map(n=>ds(n)).join(",");return`${e.op}(${t})`}}function Jo(e,t){return e instanceof q?function(n,i){return i instanceof q&&n.op===i.op&&n.field.isEqual(i.field)&&gt(n.value,i.value)}(e,t):e instanceof Dt?function(n,i){return i instanceof Dt&&n.op===i.op&&n.filters.length===i.filters.length?n.filters.reduce((s,r,o)=>s&&Jo(r,i.filters[o]),!0):!1}(e,t):void D()}function Zo(e){return e instanceof q?function(t){return`${t.field.canonicalString()} ${t.op} ${ee(t.value)}`}(e):e instanceof Dt?function(t){return t.op.toString()+" {"+t.getFilters().map(Zo).join(" ,")+"}"}(e):"Filter"}class Vh extends q{constructor(t,n,i){super(t,n,i),this.key=I.fromName(i.referenceValue)}matches(t){const n=I.comparator(t.key,this.key);return this.matchesComparison(n)}}class Uh extends q{constructor(t,n){super(t,"in",n),this.keys=ta("in",n)}matches(t){return this.keys.some(n=>n.isEqual(t.key))}}class $h extends q{constructor(t,n){super(t,"not-in",n),this.keys=ta("not-in",n)}matches(t){return!this.keys.some(n=>n.isEqual(t.key))}}function ta(e,t){var n;return(((n=t.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(i=>I.fromName(i.referenceValue))}class Bh extends q{constructor(t,n){super(t,"array-contains",n)}matches(t){const n=t.data.field(this.field);return fs(n)&&Pe(n.arrayValue,this.value)}}class Hh extends q{constructor(t,n){super(t,"in",n)}matches(t){const n=t.data.field(this.field);return n!==null&&Pe(this.value.arrayValue,n)}}class jh extends q{constructor(t,n){super(t,"not-in",n)}matches(t){if(Pe(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=t.data.field(this.field);return n!==null&&!Pe(this.value.arrayValue,n)}}class qh extends q{constructor(t,n){super(t,"array-contains-any",n)}matches(t){const n=t.data.field(this.field);return!(!fs(n)||!n.arrayValue.values)&&n.arrayValue.values.some(i=>Pe(this.value.arrayValue,i))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(t){this.fields=t,t.sort(et.comparator)}static empty(){return new ut([])}unionWith(t){let n=new rt(et.comparator);for(const i of this.fields)n=n.add(i);for(const i of t)n=n.add(i);return new ut(n.toArray())}covers(t){for(const n of this.fields)if(n.isPrefixOf(t))return!0;return!1}isEqual(t){return Jt(this.fields,t.fields,(n,i)=>n.isEqual(i))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bs{constructor(t,n,i,s){this.targetId=t,this.fromCache=n,this.Si=i,this.Di=s}static Ci(t,n){let i=nt(),s=nt();for(const r of n.docChanges)switch(r.type){case 0:i=i.add(r.doc.key);break;case 1:s=s.add(r.doc.key)}return new bs(t,n.fromCache,i,s)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ed extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const n=t.ssl?"https":"http";this.oo=n+"://"+t.host,this.uo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get co(){return!1}ao(t,n,i,s,r){const o=this.ho(t,n);w("RestConnection","Sending: ",o,i);const a={};return this.lo(a,s,r),this.fo(t,o,a,i).then(l=>(w("RestConnection","Received: ",l),l),l=>{throw as("RestConnection",`${t} failed with error: `,l,"url: ",o,"request:",i),l})}_o(t,n,i,s,r,o){return this.ao(t,n,i,s,r)}lo(t,n,i){t["X-Goog-Api-Client"]="gl-js/ fire/"+Yt,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((s,r)=>t[r]=s),i&&i.headers.forEach((s,r)=>t[r]=s)}ho(t,n){const i=Zf[t];return`${this.oo}/v1/${n}:${i}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams}fo(t,n,i,s){return new Promise((r,o)=>{const a=new yh;a.setWithCredentials(!0),a.listenOnce(ph.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case os.NO_ERROR:const u=a.getResponseJson();w("Connection","XHR received:",JSON.stringify(u)),r(u);break;case os.TIMEOUT:w("Connection",'RPC "'+t+'" timed out'),o(new C(m.DEADLINE_EXCEEDED,"Request time out"));break;case os.HTTP_ERROR:const c=a.getStatus();if(w("Connection",'RPC "'+t+'" failed with status:',c,"response text:",a.getResponseText()),c>0){let d=a.getResponseJson();Array.isArray(d)&&(d=d[0]);const f=d==null?void 0:d.error;if(f&&f.status&&f.message){const p=function(y){const S=y.toLowerCase().replace(/_/g,"-");return Object.values(m).indexOf(S)>=0?S:m.UNKNOWN}(f.status);o(new C(p,f.message))}else o(new C(m.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new C(m.UNAVAILABLE,"Connection failed."));break;default:D()}}finally{w("Connection",'RPC "'+t+'" completed.')}});const l=JSON.stringify(s);a.send(n,"POST",l,i,15)})}wo(t,n,i){const s=[this.oo,"/","google.firestore.v1.Firestore","/",t,"/channel"],r=fh(),o=dh(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(a.xmlHttpFactory=new mh({})),this.lo(a.initMessageHeaders,n,i),a.encodeInitMessageHeaders=!0;const l=s.join("");w("Connection","Creating WebChannel: "+l,a);const u=r.createWebChannel(l,a);let c=!1,d=!1;const f=new td({Hr:y=>{d?w("Connection","Not sending because WebChannel is closed:",y):(c||(w("Connection","Opening WebChannel transport."),u.open(),c=!0),w("Connection","WebChannel sending:",y),u.send(y))},Jr:()=>u.close()}),p=(y,S,b)=>{y.listen(S,A=>{try{b(A)}catch(_){setTimeout(()=>{throw _},0)}})};return p(u,Mn.EventType.OPEN,()=>{d||w("Connection","WebChannel transport opened.")}),p(u,Mn.EventType.CLOSE,()=>{d||(d=!0,w("Connection","WebChannel transport closed"),f.io())}),p(u,Mn.EventType.ERROR,y=>{d||(d=!0,as("Connection","WebChannel transport errored:",y),f.io(new C(m.UNAVAILABLE,"The operation could not be completed")))}),p(u,Mn.EventType.MESSAGE,y=>{var S;if(!d){const b=y.data[0];B(!!b);const A=b,_=A.error||((S=A[0])===null||S===void 0?void 0:S.error);if(_){w("Connection","WebChannel received error:",_);const it=_.status;let Y=function(ks){const le=$[ks];if(le!==void 0)return uf(le)}(it),Et=_.message;Y===void 0&&(Y=m.INTERNAL,Et="Unknown error status: "+it+" with message "+_.message),d=!0,f.io(new C(Y,Et)),u.close()}else w("Connection","WebChannel received:",b),f.ro(b)}}),p(o,gh.STAT_EVENT,y=>{y.stat===Fo.PROXY?w("Connection","Detected buffering proxy"):y.stat===Fo.NOPROXY&&w("Connection","Detected no buffering proxy")}),setTimeout(()=>{f.so()},0),f}}function Ts(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class od{constructor(t,n,i,s,r){this.localStore=t,this.datastore=n,this.asyncQueue=i,this.remoteSyncer={},this.fu=[],this.du=new Map,this._u=new Set,this.wu=[],this.mu=r,this.mu.Ur(o=>{i.enqueueAndForget(async()=>{Ge(this)&&(w("RemoteStore","Restarting streams for network reachability change."),await async function(a){const l=O(a);l._u.add(4),await qe(l),l.gu.set("Unknown"),l._u.delete(4),await Zn(l)}(this))})}),this.gu=new rd(i,s)}}async function Zn(e){if(Ge(e))for(const t of e.wu)await t(!0)}async function qe(e){for(const t of e.wu)await t(!1)}function Ge(e){return O(e)._u.size===0}async function Na(e,t,n){if(!Pn(t))throw t;e._u.add(1),await qe(e),e.gu.set("Offline"),n||(n=()=>Qf(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{w("RemoteStore","Retrying IndexedDB access"),await n(),e._u.delete(1),await Zn(e)})}function La(e,t){return t().catch(n=>Na(e,n,t))}async function ti(e){const t=O(e),n=kt(t);let i=t.fu.length>0?t.fu[t.fu.length-1].batchId:-1;for(;ad(t);)try{const s=await Xf(t.localStore,i);if(s===null){t.fu.length===0&&n.Fo();break}i=s.batchId,ld(t,s)}catch(s){await Na(t,s)}Oa(t)&&Ra(t)}function ad(e){return Ge(e)&&e.fu.length<10}function ld(e,t){e.fu.push(t);const n=kt(e);n.ko()&&n.Yo&&n.Xo(t.mutations)}function Oa(e){return Ge(e)&&!kt(e).No()&&e.fu.length>0}function Ra(e){kt(e).start()}async function cd(e){kt(e).eu()}async function ud(e){const t=kt(e);for(const n of e.fu)t.Xo(n.mutations)}async function hd(e,t,n){const i=e.fu.shift(),s=_s.from(i,t,n);await La(e,()=>e.remoteSyncer.applySuccessfulWrite(s)),await ti(e)}async function fd(e,t){t&&kt(e).Yo&&await async function(n,i){if(s=i.code,cf(s)&&s!==m.ABORTED){const r=n.fu.shift();kt(n).Mo(),await La(n,()=>n.remoteSyncer.rejectFailedWrite(r.batchId,i)),await ti(n)}var s}(e,t),Oa(e)&&Ra(e)}async function Ma(e,t){const n=O(e);n.asyncQueue.verifyOperationInProgress(),w("RemoteStore","RemoteStore received new credentials");const i=Ge(n);n._u.add(3),await qe(n),i&&n.gu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n._u.delete(3),await Zn(n)}async function dd(e,t){const n=O(e);t?(n._u.delete(2),await Zn(n)):t||(n._u.add(2),await qe(n),n.gu.set("Unknown"))}function kt(e){return e.Iu||(e.Iu=function(t,n,i){const s=O(t);return s.su(),new id(n,s.connection,s.authCredentials,s.appCheckCredentials,s.yt,i)}(e.datastore,e.asyncQueue,{Yr:cd.bind(null,e),Zr:fd.bind(null,e),tu:ud.bind(null,e),Zo:hd.bind(null,e)}),e.wu.push(async t=>{t?(e.Iu.Mo(),await ti(e)):(await e.Iu.stop(),e.fu.length>0&&(w("RemoteStore",`Stopping write stream with ${e.fu.length} pending writes`),e.fu=[]))})),e.Iu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _t{constructor(t,n,i){this.converter=n,this._key=i,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new xt(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new _t(this.firestore,t,this._key)}}class As{constructor(t,n,i){this.converter=n,this._query=i,this.type="query",this.firestore=t}withConverter(t){return new As(this.firestore,t,this._query)}}class xt extends As{constructor(t,n,i){super(t,n,Wh(i)),this._path=i,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new _t(this.firestore,null,new I(t))}withConverter(t){return new xt(this.firestore,t,this._path)}}function Ka(e,t,...n){if(e=fe(e),$a("collection","path",t),e instanceof ni){const i=U.fromString(t,...n);return Ha(i),new xt(e,null,i)}{if(!(e instanceof _t||e instanceof xt))throw new C(m.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(U.fromString(t,...n));return Ha(i),new xt(e.firestore,null,i)}}function za(e,t,...n){if(e=fe(e),arguments.length===1&&(t=Bo.R()),$a("doc","path",t),e instanceof ni){const i=U.fromString(t,...n);return Ba(i),new _t(e,null,new I(i))}{if(!(e instanceof _t||e instanceof xt))throw new C(m.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(U.fromString(t,...n));return Ba(i),new _t(e.firestore,e instanceof xt?e.converter:null,new I(i))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(...t){for(let n=0;n<t.length;++n)if(t[n].length===0)throw new C(m.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new et(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
